...
## Reading all activities ID and their names
...
## Reading the X values of training data
...
## Reading the X values of test data
...
## Now reading the activity id's of the Y values' test data file
...
## Casting the melted dataset according to the average of each variable for each activity and each subject
